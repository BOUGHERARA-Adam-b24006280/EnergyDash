...
<?php if (!empty($success)): ?>
    <div class="bg-green-50 border border-green-200 text-sm text-green-800 rounded-lg p-4 dark:bg-green-800/10 dark:border-green-900 dark:text-green-500 mx-2 mb-4"
        ...
        <div class="flex">
            ...
            <div class="ms-4">
                <h3 id="hs-success-label" class="text-sm font-semibold">
                ...
                <form action="<?= $action ?>" method="post">
                    <div class="grid gap-y-4">
                        ...
                        <div>
                            ...
                            <div class="relative">
                                <input type="email" id="email" placeholder="john.doe@gmail.com" name="email"
                            ...
                            <p class="hidden text-xs text-red-600 mt-2" id="email-error">Veuillez indiquer une adresse
                                mail valide afin que nous puissions vous répondre.</p>
                        </div>
                        <!-- End Form Group -->
                        ...
                        <button type="submit"
                            class="w-full py-3 px-4 inline-flex justify-center items-center gap-x-2 text-sm font-medium rounded-lg border border-transparent bg-blue-600 text-white hover:bg-blue-700 focus:outline-hidden focus:bg-blue-700 disabled:opacity-50 disabled:pointer-events-none">Connexion</button>
                    </div>
                </form>
                <!-- End Form -->
            </div>
