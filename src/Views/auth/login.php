                    ...
                    <div class="grid gap-y-4">
                        ...
                        <div>
                            <div class="flex flex-wrap justify-between items-center gap-2">
                                ...
                                <a class="inline-flex items-center gap-x-1 text-sm text-blue-600 decoration-2 hover:underline focus:outline-hidden focus:underline font-medium dark:text-blue-500" href="/forgot">Mot de passe oublié ?</a>
                            </div>
                            <div class="relative">
