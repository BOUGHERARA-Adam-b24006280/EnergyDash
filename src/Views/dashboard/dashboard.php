...
<div class="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
    ...
    <?php if (!empty($success)): ?>
        <div
            class="bg-green-100 border border-green-200 text-green-800 rounded-lg p-4 mb-6 dark:bg-green-800/10 dark:border-green-900 dark:text-green-500">
    ...
    <?php if (!empty($error)): ?>
        <div
            class="bg-red-50 border border-red-200 text-red-800 rounded-lg p-4 mb-6 dark:bg-red-800/10 dark:border-red-900 dark:text-red-500">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-12 gap-6">
        ...
        <div class="lg:col-span-4 space-y-6">
            ...
            <?php if (in_array($userRole, ['admin', 'editor'])): ?>
                ...
                <div
                    class="bg-white border border-gray-200 shadow-sm rounded-xl dark:bg-neutral-900 dark:border-neutral-700 p-5">
            ...
            <div
                ...
                <form id="energyForm" class="space-y-4">
                    ...
                    <div>
                        ...
                        <select name="city"
                            class="py-2 px-3 block w-full border-gray-200 rounded-lg text-sm dark:bg-neutral-800 dark:border-neutral-700 dark:text-gray-400">
                    ...
                    <div class="grid grid-cols-2 gap-2">
                        <div>
                            ...
                            <input type="date" name="from" value="2023-12-01"
                                class="py-2 px-3 block w-full border-gray-200 rounded-lg text-sm dark:bg-neutral-800 dark:border-neutral-700 dark:text-gray-400">
                        </div>
                        <div>
                            <label class="block text-sm font-medium mb-1 dark:text-white">Au</label>
                            <input type="date" name="to" value="2023-12-31"
                                class="py-2 px-3 block w-full border-gray-200 rounded-lg text-sm dark:bg-neutral-800 dark:border-neutral-700 dark:text-gray-400">
                        </div>
                    </div>

                    <div class="mt-4">
                        <span class="block text-sm font-medium mb-2 dark:text-white">Donnée secondaire (Axe de droite)
                            :</span>
                        <div class="flex gap-4">
                            <label class="inline-flex items-center cursor-pointer">
                                <input type="radio" name="secondaryView" value="none" checked
                                    class="form-radio text-gray-600 border-gray-300 focus:ring-gray-500">
                                <span class="ml-2 text-sm dark:text-gray-300">Aucune</span>
                            </label>

                            <label class="inline-flex items-center cursor-pointer">
                                <input type="radio" name="secondaryView" value="meteo"
                            ...
                            <label class="inline-flex items-center cursor-pointer">
                                <input type="radio" name="secondaryView" value="temp"
                    ...
                    <button type="submit"
                        class="w-full py-2 px-3 bg-blue-600 text-white rounded-lg hover:bg-blue-700 text-sm font-semibold transition-colors">
        ...
        <div class="lg:col-span-8">
            <div
                class="bg-white border border-gray-200 shadow-sm rounded-xl dark:bg-neutral-900 dark:border-neutral-700 p-5 h-full min-h-[500px] flex flex-col">
